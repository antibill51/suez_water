...
SENSORS: tuple[SuezWaterSensorEntityDescription, ...] = (
    ...
    SuezWaterSensorEntityDescription(
        ...
        attr_fn=lambda suez_data: {
            ...
            "url_qualite": suez_data.quality.quality_url,
            "analyses_bacteriologiques": suez_data.quality.bacterio_analyses,
            "analyses_nitrates_12m": suez_data.quality.nitrates_analyses,
        }
    ...
    SuezWaterSensorEntityDescription(
        key="water_total_chlorine",
        translation_key="water_total_chlorine",
        icon="mdi:flask-outline",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda suez_data: suez_data.quality.total_chlorine if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_ecoli",
    ...
    SuezWaterSensorEntityDescription(
        key="water_calcium",
        translation_key="water_calcium",
        icon="mdi:shaker-outline",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda suez_data: suez_data.quality.calcium if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_magnesium",
        translation_key="water_magnesium",
        icon="mdi:water-outline",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda suez_data: suez_data.quality.magnesium if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_sodium",
        translation_key="water_sodium",
        icon="mdi:shaker-outline",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda suez_data: suez_data.quality.sodium if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_potassium",
        translation_key="water_potassium",
        icon="mdi:leaf",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda suez_data: suez_data.quality.potassium if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_bicarbonates",
        translation_key="water_bicarbonates",
        icon="mdi:molecule",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda suez_data: suez_data.quality.bicarbonates if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_fluor",
        translation_key="water_fluor",
        icon="mdi:tooth-outline",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=3,
        value_fn=lambda suez_data: suez_data.quality.fluor if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_chlorides",
        translation_key="water_chlorides",
        icon="mdi:flask",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda suez_data: suez_data.quality.chlorides if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_sulfates",
        translation_key="water_sulfates",
        icon="mdi:molecule",
        native_unit_of_measurement="mg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda suez_data: suez_data.quality.sulfates if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_conductivity",
        translation_key="water_conductivity",
        icon="mdi:lightning-bolt-outline",
        native_unit_of_measurement="µS/cm",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
        value_fn=lambda suez_data: suez_data.quality.conductivity if suez_data.quality else None,
    ),
    SuezWaterSensorEntityDescription(
        key="water_pesticides_total",
        translation_key="water_pesticides_total",
        icon="mdi:sprout-outline",
        native_unit_of_measurement="µg/L",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=3,
        value_fn=lambda suez_data: suez_data.quality.pesticides_total if suez_data.quality else None,
        attr_fn=lambda suez_data: {
            "analyses": suez_data.quality.pesticides_analyses,
            "limite_reglementaire": "0.5 µg/L",
        }
        if suez_data.quality and suez_data.quality.pesticides_analyses is not None
        else None,
    ),
)
